...
with open('Hacked through DES, RSA and Proposed Algorithm (Edge).csv', 'r') as csvfile:
...
plt.legend(['DES Encryption','DES Decryption','RSA Encryption','RSA Decryption','Proposed Encryption', 'Proposed Decryption'],bbox_to_anchor=(0., .93, 1., .102), loc=3,
       ncol=2, mode="expand", borderaxespad=0.)


txt="Hacked through DES, RSA and Proposed Algorithm (Edge)"
# center text
