...
DataX_Y_1D = np.loadtxt("Data passing through AES, RSA and Proposed Algorithm (Fog).csv", delimiter=",")
...
#plt.title('Not Hacked through DES, RSA and Proposed Algorithm (Edge)', +loc, loc=l)
