...
ax.set_xlabel('Block Number (Unit) \n\n Data passing through AES, RSA and Proposed Algorithm (Fog)')
...
plt.legend(['AES Encryption','AES Decryption','RSA Encryption','RSA Decryption','Proposed Encryption', 'Proposed Decryption'])
