...
DataX_Y_1D = np.loadtxt("Not Hacked through DES, RSA and Proposed Algorithm (Edge).csv", delimiter=",")
...
plt.xlabel('DES Algorithm')
plt.ylabel('RSA Algorithm')
ax.set_zlabel('Proposed Algorithm')
#plt.title('Not Hacked through DES, RSA and Proposed Algorithm (Edge)')

txt="Not Hacked through DES, RSA and Proposed Algorithm (Edge)"
# center text
