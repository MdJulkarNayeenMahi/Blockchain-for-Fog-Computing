...
DataX_Y_1D = np.loadtxt("Hacked through AES, RSA and Proposed Algorithm (Edge).csv", delimiter=",")
...
plt.xlabel('AES Algorithm')
plt.ylabel('RSA Algorithm')
ax.set_zlabel('Proposed Algorithm')
#plt.title('Not Hacked through AES, RSA and Proposed Algorithm (Edge)')
