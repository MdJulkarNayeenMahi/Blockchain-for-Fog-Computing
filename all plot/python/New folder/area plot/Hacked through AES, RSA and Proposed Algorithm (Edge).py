...
with open('Hacked through AES, RSA and Proposed Algorithm (Edge).csv', 'r') as csvfile:
...
plt.plot([],[],color='#60b1fd', label='AES Encryption', linewidth=5)
plt.plot([],[],color='#fd9760', label='AES Decryption', linewidth=5)
...
txt="Hacked through AES, RSA and Proposed Algorithm (Edge)"
# center text
